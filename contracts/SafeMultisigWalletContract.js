...
class SafeMultisigWalletContract {
    /**
    ...
    */
    ...
    /**
     * @typedef SafeMultisigWalletContract_submitTransaction
     * @type {object}
     ...
     * @param {cell} params.payload
     * @return {Promise.<SafeMultisigWalletContract_submitTransaction>}
     */
    ...
    /**
     * @typedef SafeMultisigWalletContract_isConfirmed
     * @type {object}
     ...
     * @return {Promise.<SafeMultisigWalletContract_isConfirmed>}
     */
    isConfirmed(params) {
    ...
    /**
     * @typedef SafeMultisigWalletContract_getParameters
     * @type {object}
    ...
    /**
     * @return {Promise.<SafeMultisigWalletContract_getParameters>}
     */
    getParameters() {
    ...
    /**
     * @typedef SafeMultisigWalletContract_getTransaction
     * @type {object}
     ...
     * @param {object} params
     * @param {uint64} params.transactionId
     * @return {Promise.<SafeMultisigWalletContract_getTransaction>}
     */
    ...
    /**
     * @typedef SafeMultisigWalletContract_getTransactions
     * @type {object}
     * @property {tuple[]} transactions 
     */

    /**
     * @return {Promise.<SafeMultisigWalletContract_getTransactions>}
     */
    getTransactions() {
    ...
    /**
     * @typedef SafeMultisigWalletContract_getTransactionIds
     * @type {object}
     * @property {uint64[]} ids 
     */

    /**
     * @return {Promise.<SafeMultisigWalletContract_getTransactionIds>}
     */
    getTransactionIds() {
    ...
    /**
     * @typedef SafeMultisigWalletContract_getCustodians
     * @type {object}
     * @property {tuple[]} custodians 
     */

    /**
     * @return {Promise.<SafeMultisigWalletContract_getCustodians>}
     */
    getCustodians() {
...
SafeMultisigWalletContract.package = pkg;
